...
/**Created by Arezou-Ghorbani on 12,November,2023,ArezouGhorbaniii@gmail**/
@AndroidEntryPoint
class ProfileAddressFragment : BaseFragment() {
    ...
    private fun initRecycler(data: List<ResponseProfileAddresses.ResponseProfileAddressesItem>) {
        binding.apply {
