...
import com.example.store.ui.detail.adapters.ImagesAdapter
import com.example.store.ui.detail.adapters.PagerAdapter
...
class DetailFragment : BaseFragment() {
    ...
    private fun initImagesRecycler(data: List<String>) {
        ...
        binding.detailHeaderLay.productImagesList.setupRecyclerview(
            LinearLayoutManager(
                requireContext()
            ), imagesAdapter
        )
